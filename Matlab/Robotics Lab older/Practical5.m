...
clear;
close all
[n, J, m, l, dxcom, dycom, dzcom, Ixx, Iyy, Izz, Ixy, Iyz, Izx, a, alp, d, th, qi, qf, dEn, incr, g, T , t] = Inputs();
V=0.3;
j=1;
...
%         [q, dqi, ddqi] = linear_traj(qi,qf,V,t,T,J);
%         [q,dqi,ddqi]=linear_trajD(J,qi,qf,T,t)
    %Forward Recursion
    [Ti0, oi0, z, dc, r, rn, w, dw, pe0, ao, ac, mo, f] = fkin(n, m, J, dxcom, dycom, dzcom, Ixx, Iyy, Izz, Ixy, Iyz, Izx, a, alp, d, th, qi, dEn, q, dqi, ddqi);
